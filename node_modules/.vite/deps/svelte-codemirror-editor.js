...
var indentLess = ({ state, dispatch }) => {
  ...
  dispatch(state.update(changeBySelectedLine(state, (line, changes) => {
    ...
    while (keep < space2.length && keep < insert.length && space2.charCodeAt(keep) == insert.charCodeAt(keep))
      keep++;
    changes.push({ from: line.from + keep, to: line.from + space2.length, insert: insert.slice(keep) });
...
// node_modules/svelte-codemirror-editor/util.js
...
// node_modules/svelte-codemirror-editor/CodeMirror.svelte
var file = "node_modules/svelte-codemirror-editor/CodeMirror.svelte";
function add_css(target) {
  append_styles(target, "svelte-kcx0g9", ".codemirror-wrapper.svelte-kcx0g9 .cm-focused{outline:none}.scm-waiting.svelte-kcx0g9{position:relative}.scm-waiting__loading.svelte-kcx0g9{position:absolute;top:0;left:0;bottom:0;right:0;background-color:rgba(255, 255, 255, 0.5)}.scm-loading.svelte-kcx0g9{display:flex;align-items:center;justify-content:center}.scm-loading__spinner.svelte-kcx0g9{width:1rem;height:1rem;border-radius:100%;border:solid 2px #000;border-top-color:transparent;margin-right:0.75rem;animation:svelte-kcx0g9-spin 1s linear infinite}.scm-loading__text.svelte-kcx0g9{font-family:sans-serif}.scm-pre.svelte-kcx0g9{font-size:0.85rem;font-family:monospace;tab-size:2;-moz-tab-size:2;resize:none;pointer-events:none;user-select:none;overflow:auto}@keyframes svelte-kcx0g9-spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_else_block(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      t1 = claim_text(p_nodes, "Loading editor...");
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 123, 12, 3650);
      attr_dev(p, "class", "scm-loading__text svelte-kcx0g9");
      add_location(p, file, 124, 12, 3699);
      attr_dev(div1, "class", "scm-waiting__loading scm-loading svelte-kcx0g9");
      add_location(div1, file, 122, 8, 3591);
      attr_dev(pre, "class", "scm-pre cm-editor svelte-kcx0g9");
      add_location(pre, file, 127, 8, 3774);
      attr_dev(div2, "class", div2_class_value = "scm-waiting " + /*classes*/
      ctx[1] + " svelte-kcx0g9");
      add_location(div2, file, 121, 4, 3547);
    },
    ...
    p: function update(ctx2, dirty) {
      ...
      if (dirty & /*classes*/
      2 && div2_class_value !== (div2_class_value = "scm-waiting " + /*classes*/
      ctx2[1] + " svelte-kcx0g9")) {
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", div_class_value = "codemirror-wrapper " + /*classes*/
      ctx[1] + " svelte-kcx0g9");
      add_location(div, file, 119, 4, 3470);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, dirty) {
      if (dirty & /*classes*/
      2 && div_class_value !== (div_class_value = "codemirror-wrapper " + /*classes*/
      ctx2[1] + " svelte-kcx0g9")) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let { placeholder: placeholder2 = void 0 } = $$props;
  ...
  onDestroy(() => view == null ? void 0 : view.destroy());
  ...
  function get_base_extensions(basic2, useTab2, tabSize2, lineWrapping2, placeholder3, editable2, readonly2, lang2) {
    const extensions2 = [
    ...
    if (placeholder3)
      extensions2.push(placeholder(placeholder3));
    if (lang2)
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
      console.warn(`<CodeMirror> was created with unknown prop '${key}'`);
  });
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("useTab" in $$props2)
      $$invalidate(8, useTab = $$props2.useTab);
    if ("tabSize" in $$props2)
      $$invalidate(9, tabSize = $$props2.tabSize);
    if ("styles" in $$props2)
      $$invalidate(10, styles = $$props2.styles);
    if ("lineWrapping" in $$props2)
      $$invalidate(11, lineWrapping = $$props2.lineWrapping);
    if ("editable" in $$props2)
      $$invalidate(12, editable = $$props2.editable);
    if ("readonly" in $$props2)
      $$invalidate(13, readonly = $$props2.readonly);
    if ("placeholder" in $$props2)
      $$invalidate(14, placeholder2 = $$props2.placeholder);
  };
  $$self.$capture_state = () => ({
    createEventDispatcher,
    onDestroy,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("view" in $$props2)
      $$invalidate(15, view = $$props2.view);
    if ("update_from_prop" in $$props2)
      update_from_prop = $$props2.update_from_prop;
    if ("update_from_state" in $$props2)
      update_from_state = $$props2.update_from_state;
    if ("first_config" in $$props2)
      first_config = $$props2.first_config;
    if ("first_update" in $$props2)
      first_update = $$props2.first_update;
    if ("state_extensions" in $$props2)
      $$invalidate(16, state_extensions = $$props2.state_extensions);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*basic, useTab, tabSize, lineWrapping, placeholder, editable, readonly, lang, theme, styles, extensions*/
    32752) {
      $:
        $$invalidate(16, state_extensions = [
          ...get_base_extensions(basic, useTab, tabSize, lineWrapping, placeholder2, editable, readonly, lang),
          ...get_theme(theme, styles),
          ...extensions
        ]);
    }
    if ($$self.$$.dirty & /*view, value*/
    32769) {
      $:
        view && update(value);
    }
    if ($$self.$$.dirty & /*view, state_extensions*/
    98304) {
      $:
...
var CodeMirror = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(
      this,
...
//# sourceMappingURL=svelte-codemirror-editor.js.map
